...
namespace LibrarySystem19011768
{
    public class Worker
    {
        ...
        //Calling number to store the calling number and their description
        public static Dictionary<string, string> callingNumbers = new Dictionary<string, string>()
        {
        ...
        public void CheckTime(Label lblSeconds, Label lblMinutes, string finalTime)
        {
